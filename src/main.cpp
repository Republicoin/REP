...
#if defined(NDEBUG)
# error "Republicoin cannot be compiled without assertions."
#endif
...
unsigned int nModifierInterval = 10 * 60; // time to elapse before new restaking can occur
...
const string strMessageMagic = "Republicoin Signed Message:\n";
...
{
    RenameThread("republicoin-loadblk");
